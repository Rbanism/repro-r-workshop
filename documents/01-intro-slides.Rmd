...
> - **Organised as part of [Rbanism](https://www.esciencecenter.nl/claudiu-forgaci/)**, a Netherlands eScience Centre fellowship project.
...
-   What tools do you use (Excel / R / Python / Word / plain text etc.)?
...
Let's walk through generation of new plots for the 1970s and 1980s and 1990s plus (these new analyses are already in the `intro-demo.Rmd` document).
